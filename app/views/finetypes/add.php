        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="mt-4 text-primary">
                    <i class="fas fa-plus-circle mr-2"></i> Yeni Ceza Tipi Ekle
                </h2>
                <div>
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo URLROOT; ?>/finetypes/add" method="post">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group text-center mt-4">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fas fa-save mr-2"></i> Ceza Tipini Kaydet
                            </button>
                        </div>
                    </form>
                </div>
