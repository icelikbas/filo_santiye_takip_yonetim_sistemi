...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Süresi Geçmiş Muayeneler</li>
    </ol>
    
    <div class="card mb-4">
        <div class="card-header bg-danger text-white">
            <i class="fas fa-exclamation-triangle me-1"></i>
            Muayene Süresi Geçmiş Araçlar
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="expiredInspectionsTable">
                    <thead>
                        <tr>
                            <th>Plaka</th>
                            <th>Araç Bilgisi</th>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" class="text-center">Süresi geçmiş muayene bulunmamaktadır</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle"></i> <strong>Dikkat!</strong> Süresi geçmiş muayenesi olan araçların trafiğe çıkması yasaktır.
                    </div>
                    <p>Muayene süresi geçmiş araçlar için:</p>
                    <ul>
                        <li>Trafik cezası uygulanır</li>
                        <li>Zorunlu trafik sigortası güvence kapsamında sınırlamalar olabilir</li>
                        <li>Kaza durumunda sigorta şirketi tazminat ödemeyebilir</li>
                        <li>Gecikme cezalı muayene ücreti ödenir</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-circle"></i> <strong>Acil Aksiyon!</strong> Süresi geçmiş muayenesi olan araçların en kısa sürede muayenelerini yaptırın.
                    </div>
                    <ul class="list-group">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // DataTables başlat
        $('#expiredInspectionsTable').DataTable({
            language: {
                url: '//cdn.datatables.net/plug-ins/1.13.4/i18n/tr.json'
            },
            order: [[4, 'desc']] // Gecikme sütununa göre azalan sıralama
        });
    ...
    function calculateDelayStatistics() {
        ...
        const table = document.getElementById('expiredInspectionsTable');
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            if (cells.length > 0 && cells[4]) { // Gecikme sütunu kontrolü
                const delayText = cells[4].textContent.trim();
