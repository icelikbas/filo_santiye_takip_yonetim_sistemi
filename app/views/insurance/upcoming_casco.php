...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Yaklaşan Kasko Sigortaları</li>
    </ol>
    
    <div class="card mb-4">
        <div class="card-header">
            <i class="fas fa-shield-alt me-1"></i>
            <?php echo $data['days']; ?> Gün İçinde Süresi Dolacak Kasko Sigortaları
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="upcomingCascoTable">
                    <thead>
                        <tr>
                            <th>Plaka</th>
                            <th>Araç Bilgisi</th>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="8" class="text-center">Önümüzdeki <?php echo $data['days']; ?> gün içinde süresi dolacak kasko sigortası bulunamadı</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle"></i> <strong>Dikkat!</strong> Kasko sigortası süresi yaklaşan araçların durumunu kontrol edin.
                    </div>
                    <ul class="list-group">
                        <li class="list-group-item">
                            <i class="fas fa-check-circle text-success me-2"></i> Araç değerini güncel tutun
                        </li>
                        <li class="list-group-item">
                            <i class="fas fa-check-circle text-success me-2"></i> Kasko teklifi almak için sigortacınızla iletişime geçin
                        </li>
                        <li class="list-group-item">
                            <i class="fas fa-check-circle text-success me-2"></i> Araçta bulunan ek aksesuarları sigorta kapsamına dahil edin
                        </li>
                        <li class="list-group-item">
                            <i class="fas fa-check-circle text-success me-2"></i> Sigorta şirketinizin anlaşmalı servislerini öğrenin
                        </li>
                    </ul>
                </div>
            </div>
...
<script>
    ...
    function calculateStatistics() {
        ...
        const table = document.getElementById('upcomingCascoTable');
