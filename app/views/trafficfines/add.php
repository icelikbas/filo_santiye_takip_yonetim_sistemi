        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="mt-4 text-primary">
                    <i class="fas fa-plus-circle mr-2"></i> Yeni Trafik Cezası Ekle
                </h2>
                <div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo URLROOT; ?>/trafficfines/add" method="post">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="invalid-feedback"><?php echo $data['fine_type_id_err']; ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center mt-4">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fas fa-save mr-2"></i> Cezayı Kaydet
                            </button>
                        </div>
                    </form>
                </div>
