...
<div class="card">
    <div class="card-header">
        <h4><i class="fas fa-gas-pump mr-2"></i>Tank Düzenle</h4>
    </div>
    <div class="card-body">
        <form action="<?php echo URLROOT; ?>/tanks/edit/<?php echo $data['id']; ?>" method="post">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col">
                    <input type="submit" value="Tank Güncelle" class="btn btn-warning">
