...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-edit mr-2"></i>Sertifika Düzenle</h1>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo URLROOT; ?>/certificates/edit/<?php echo $data['driver_id']; ?>/<?php echo $data['id']; ?>" method="post">
