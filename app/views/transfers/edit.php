...
<div class="card">
    <div class="card-header">
        <h4><i class="fas fa-exchange-alt mr-2"></i>Yakıt Transferi Düzenle</h4>
    </div>
    <div class="card-body">
        <form action="<?php echo URLROOT; ?>/transfers/edit/<?php echo $data['id']; ?>" method="post">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col">
                    <input type="submit" value="Transfer Güncelle" class="btn btn-warning">
