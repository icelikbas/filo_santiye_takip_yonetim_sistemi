    ...
    <div class="row mb-3">
        <div class="col">
            <h1 class="h3 mb-2 text-gray-800">
                <i class="fas fa-edit text-primary mr-2"></i>Şirket Düzenle
            </h1>
            <p class="mb-4">Şirket bilgilerini güncellemek için formu kullanın.</p>
        </div>
    </div>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="post" action="<?php echo URLROOT; ?>/companies/edit/<?php echo $data['id']; ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2">
                            <img src="<?php echo URLROOT . '/' . $data['logo_url']; ?>" alt="Mevcut Logo" class="img-thumbnail" style="max-height: 100px;">
                            <p class="small text-muted mt-1">Mevcut logo. Değiştirmek için yeni bir dosya seçin.</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <a href="<?php echo URLROOT; ?>/companies/show/<?php echo $data['id']; ?>" class="btn btn-info">
